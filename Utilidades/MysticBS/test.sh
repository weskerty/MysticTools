...
mkdir -p ~/.gyp ~/android-ndk

echo -e "\e[1;32m⬇️ Descargando e instalando Android NDK...\e[0m"
curl -fSL https://github.com/lzhiyong/termux-ndk/releases/download/android-ndk/android-ndk-r27b-aarch64.zip | \
unzip - -d ~/android-ndk
